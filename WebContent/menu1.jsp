    ...
    <body>
        ...
        <div id="content">
	        <div>
	            <div>
					<h1>Bread</h1>
					<p><img src = "imgs/Bread01.jpg" ></p>
					<p><img src = "imgs/Bread02.jpg" ></p>
					<p><img src = "imgs/Bread03.jpg" ></p>
				</div>
			</div>
			<div>
	            <div>
					<p><img src = "imgs/Bread04.jpg" ></p>
					<p><img src = "imgs/Bread05.jpg" ></p>
					<p><img src = "imgs/Bread06.jpg" ></p>
				</div>
			</div>
        </div>
        <div id="footer">
